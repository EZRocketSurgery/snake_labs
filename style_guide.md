...
RULES:
- Snakes write in snake_case. If it was named by a snake then it should be formatted like: named_by_a_snake
- The puzzle is solved with user-inputted Python code.
